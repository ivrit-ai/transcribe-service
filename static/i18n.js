(function () {
  const he = {
    ...
    runpodKeySavedHint: "מפתח שמור המסתיים ב-…{hint}",
    removeRunpodKey: "הסר מפתח RunPod",
    runpodKeyRemoved: "מפתח ה-RunPod הוסר",
    runpodKeyLoadFailed: "לא הצלחנו לטעון את מפתח ה-RunPod השמור שלך. אנא הזן אותו מחדש בהגדרות.",
    runpodKeyMigrationFailed: "לא הצלחנו לאמת את מפתח ה-RunPod השמור שלך. אנא הזן אותו מחדש בהגדרות.",
    ...
    tabViewer: "צפייה",
    openDataDir: "הצג נתיב תיקייה",
    dataDirCopied: "הנתיב הוצג",
    dataDirWarning: "שינוי, מחיקה או שינוי שם של קבצים בתיקייה זו עלול לפגוע בנתונים המאוחסנים שלך באופן בלתי הפיך.\n\nיש לנהוג בזהירות רבה.\n\nלהמשיך?",
    ...
    deleteFile: "מחק קובץ",
    quotaRefunded: "הדקות הוחזרו למכסה שלך",
    ...
    discardRecording: "מחק הקלטה",
    recordingDownloaded: "ההקלטה הורדה בהצלחה",
    recordingDiscarded: "ההקלטה נמחקה",
    recordingNotBackedUp: "לא ניתן לגבות את ההקלטה בדפדפן, ולכן היא נשמרת בזיכרון בלבד. מומלץ להוריד אותה בסיום ההקלטה.",
    recoveredRecordingFound: "נמצאה הקלטה שטרם נשלחה לתמלול",
    recoveredRecordingInterrupted: "נמצאה הקלטה שנקטעה לפני שהסתיימה",
    recoveredRecordingHint: "ההקלטה שמורה בדפדפן שלך. אפשר לתמלל אותה עכשיו, להוריד אותה למחשב, או למחוק אותה.",
    recordingReadyToTranscribe: "ההקלטה מוכנה לתמלול. לחץ על \"תמלל\" להמשך.",
    recordingReadFailed: "לא ניתן לטעון את ההקלטה כרגע, אך היא שמורה בדפדפן. רענן את הדף כדי לשחזר אותה.",
    pushPromptTitle: "לקבל התראה כשהתמלול מוכן?",
    pushPromptBody: "התמלול ממשיך גם אם תסגרו את הדפדפן. נוכל לשלוח לכם התראה ברגע שהוא מוכן.",
    pushPromptYes: "כן, עדכנו אותי",
    pushPromptNo: "לא עכשיו",
    pushPromptDontAsk: "אל תשאלו אותי שוב",
    pushEnabled: "נשלח לכם התראה כשהתמלול יהיה מוכן.",
    pushDenied: "לא הצלחנו להפעיל התראות. אפשר לאשר אותן בהגדרות הדפדפן.",
    installApp: "התקנה",
    installTitle: "התקנת האפליקציה",
    installWhy: "האפליקציה תיפתח ממסך הבית כמו כל אפליקציה אחרת.",
    installWhyNotifications: "באייפון זו גם הדרך היחידה לקבל התראה כשהתמלול מוכן.",
    installStepsIos: "פתחו את תפריט השיתוף בסרגל הכלים של Safari ובחרו ״הוספה למסך הבית״.",
    installDone: "הבנתי",
    ...
    errorDriveStorageFull: "ה-Google Drive שלך מלא, ולכן לא ניתן לשמור את התמלול. פנו מקום ונסו שוב.",
    ...
    errorRunpodKeyVerifyFailed: "לא הצלחנו לאמת את מפתח ה-RunPod. אנא בדוק שהמפתח נכון ונסה שוב.",
    errorRunpodKeySaveFailed: "לא הצלחנו לשמור את מפתח ה-RunPod ב-Google Drive שלך. אנא נסה שוב.",
    errorRunpodKeyRemoveFailed: "לא הצלחנו להסיר את מפתח ה-RunPod. אנא נסה שוב.",
  ...
  const yi = {
    ...
    runpodKeySavedHint: "אויפֿגעהיטענער קלעף וואָס ענדיקט זיך מיט …{hint}",
    removeRunpodKey: "אַראָפּנעמען RunPod קלעף",
    runpodKeyRemoved: "RunPod קלעף איז אַראָפּגענומען געוואָרן",
    runpodKeyLoadFailed: "מיר האָבן נישט געקענט לאָדן אײַער אויפֿגעהיטענעם RunPod קלעף. ביטע גיט אים אַרײַן נאָך אַ מאָל אין די איינשטעלונגען.",
    runpodKeyMigrationFailed: "מיר האָבן נישט געקענט באַשטעטיקן אײַער אויפֿגעהיטענעם RunPod קלעף. ביטע גיט אים אַרײַן נאָך אַ מאָל אין די איינשטעלונגען.",
    ...
    tabViewer: "באַקוקן",
    openDataDir: "קאָפּירן טעקע־וועג",
    dataDirCopied: "דער וועג איז קאָפּירט",
    dataDirWarning: "ענדערן, אויסמעקן אָדער באַנענען טעקעס אין דעם טעקע קען באַשעדיקן אייערע אויפֿגעהיטע דאַטן אומאומקערלעך.\n\nביטע זייט זייער אָפּגעהיט.\n\nפֿאָרזעצן?",
    ...
    quotaRefunded: "די מינוט זענען צוריקגעגעבן געוואָרן צו דיין קוואָטע",
    ...
    discardRecording: "אויסמעקן רעקאָרדירונג",
    recordingDownloaded: "רעקאָרדירונג אַראָפּגעלאָדן געראָטן",
    recordingDiscarded: "רעקאָרדירונג אויסגעמעקט",
    recordingNotBackedUp: "מען קען נישט אויפֿהיטן די רעקאָרדירונג אין בראַוזער, זי בלײַבט נאָר אין זכּרון. לאָדט זי אַראָפּ ווען איר ענדיקט.",
    recoveredRecordingFound: "עס איז דאָ אַ רעקאָרדירונג וואָס איז נאָך נישט געשיקט געוואָרן צו טראַנסקריבירן",
    recoveredRecordingInterrupted: "עס איז דאָ אַ רעקאָרדירונג וואָס איז איבערגעריסן געוואָרן",
    recoveredRecordingHint: "זי איז אויפֿגעהיט אין אײַער בראַוזער. איר קענט זי איצט טראַנסקריבירן, אַראָפּלאָדן, אָדער אויסמעקן.",
    recordingReadyToTranscribe: "רעקאָרדירונג איז גרייט פֿאַר טראַנסקריפּציע. דריקט \"טראַנסקריבער\" צו פֿאָרזעצן.",
    recordingReadFailed: "מען קען איצט נישט לאָדן די רעקאָרדירונג, אָבער זי איז אויפֿגעהיט אין בראַוזער. פֿרישט אויף די בלאַט צו קריגן זי צוריק.",
    pushPromptTitle: "באַקומען אַ מעלדונג ווען די טראַנסקריפּציע איז גרייט?",
    pushPromptBody: "די טראַנסקריפּציע גייט אָן אויך אויב איר פֿאַרמאַכט דעם בראַוזער. מיר קענען אײַך שיקן אַ מעלדונג ווען זי איז גרייט.",
    pushPromptYes: "יאָ, לאָזט מיך וויסן",
    pushPromptNo: "נישט איצט",
    pushPromptDontAsk: "פֿרעגט מיך נישט נאָך אַ מאָל",
    pushEnabled: "מיר וועלן אײַך שיקן אַ מעלדונג ווען די טראַנסקריפּציע איז גרייט.",
    pushDenied: "מיר האָבן נישט געקענט אָנשטעלן מעלדונגען. איר קענט זיי דערלויבן אין די בראַוזער־איינשטעלונגען.",
    installApp: "אינסטאַלירן",
    installTitle: "אינסטאַלירן די אַפּליקאַציע",
    installWhy: "די אַפּליקאַציע וועט זיך עפֿענען פֿונעם היים־עקראַן ווי יעדע אַנדערע אַפּליקאַציע.",
    installWhyNotifications: "אויפֿן iPhone איז דאָס אויך דער איינציקער וועג צו באַקומען אַ מעלדונג ווען די טראַנסקריפּציע איז גרייט.",
    installStepsIos: "עפֿנט דעם טיילן־מעניו אין Safari און קלײַבט אויס ״צוגעבן צום היים־עקראַן״.",
    installDone: "פֿאַרשטאַנען",
    installed: "די אַפּליקאַציע איז אינסטאַלירט געוואָרן.",
    ...
    errorDriveStorageFull: "דײַן Google Drive איז פֿול, און מ׳קען נישט אָפּהיטן דעם טראַנסקריפּט. ביטע מאַכט פּלאַץ און פּרוּווט ווידער.",
    ...
    errorRunpodKeyVerifyFailed: "מיר האָבן נישט געקענט באַשטעטיקן דעם RunPod קלעף. ביטע קאָנטראָלירט דעם קלעף און פּרוּווט ווידער.",
    errorRunpodKeySaveFailed: "מיר האָבן נישט געקענט אויפֿהיטן דעם RunPod קלעף אין אײַער Google Drive. ביטע פּרוּווט ווידער.",
    errorRunpodKeyRemoveFailed: "מיר האָבן נישט געקענט אַראָפּנעמען דעם RunPod קלעף. ביטע פּרוּווט ווידער.",
  ...
  const en = {
    ...
    runpodKeySavedHint: "Saved key ending in …{hint}",
    removeRunpodKey: "Remove RunPod key",
    runpodKeyRemoved: "RunPod key removed",
    runpodKeyLoadFailed: "We couldn't load your saved RunPod key. Please enter it again in settings.",
    runpodKeyMigrationFailed: "We couldn't verify your saved RunPod key. Please enter it again in settings.",
    ...
    tabMyFiles: "My Files",
    tabViewer: "Viewer",
    openDataDir: "Copy Folder Path",
    dataDirCopied: "Path copied to clipboard",
    dataDirWarning: "Modifying, deleting, or renaming files in this directory can irreversibly damage your stored data.\n\nProceed with extreme caution.\n\nContinue?",
    ...
    quotaRefunded: "Minutes returned to your quota",
    ...
    recordingNotBackedUp: "This recording can't be backed up in your browser, so it is kept in memory only. Download it when you finish recording.",
    recoveredRecordingFound: "You have a recording that was never sent for transcription",
    recoveredRecordingInterrupted: "You have a recording that was interrupted before it finished",
    recoveredRecordingHint: "It is saved in your browser. You can transcribe it now, download it to your computer, or discard it.",
    recordingReadyToTranscribe: "Recording is ready for transcription. Click \"Transcribe\" to continue.",
    recordingReadFailed: "The recording could not be loaded right now, but it is saved in your browser. Reload the page to recover it.",
    pushPromptTitle: "Get a notification when your transcription is ready?",
    pushPromptBody: "Transcription continues even if you close your browser. We can notify you the moment it is ready.",
    pushPromptYes: "Yes, notify me",
    pushPromptNo: "Not now",
    pushPromptDontAsk: "Don't ask me again",
    pushEnabled: "We'll notify you when your transcription is ready.",
    pushDenied: "We couldn't turn on notifications. You can allow them in your browser settings.",
    installApp: "Install",
    installTitle: "Install the app",
    installWhy: "The app opens from your home screen like any other app.",
    installWhyNotifications: "On iPhone, installing it is also the only way to get a notification when your transcription is ready.",
    installStepsIos: "Open the Share menu in Safari's toolbar and choose \"Add to Home Screen\".",
    installDone: "Got it",
    ...
    errorDriveStorageFull: "Your Google Drive is full, so the transcript cannot be saved. Please free up space and try again.",
    ...
    errorInternalServer: "Internal server error",
    errorBalanceFetchFailed: "Failed to fetch balance",
    errorRunpodKeyVerifyFailed: "We couldn't verify this RunPod key. Please check the key and try again.",
    errorRunpodKeySaveFailed: "We couldn't save your RunPod key to your Google Drive. Please try again.",
    errorRunpodKeyRemoveFailed: "We couldn't remove your RunPod key. Please try again.",
    errorInvalidJson: "Invalid JSON body",
    errorMissingFileSize: "Missing file_size",
    errorInvalidFileSize: "Invalid file_size",
    tabStats: "Statistics",
