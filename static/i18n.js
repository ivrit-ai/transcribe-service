(function () {
  const he = {
    ...
    ffmpegSettingsHeader: "עיבוד בדפדפן",
    ffmpegAutoLabel: "בחירה אוטומטית",
    ffmpegAutoHelp: "המערכת תבחר אם לבצע המרה מקומית לפי יכולות המכשיר.",
    ffmpegLocalOnly: "המר בדפדפן",
    ffmpegLocalOnlyHelp: "ממיר ל-Opus לפני ההעלאה (מהיר יותר ומקטין את כמות הנתונים).",
    ffmpegServerOnly: "המר בשרת",
    ffmpegServerOnlyHelp: "מדלג על המרה מקומית ושולח את הקובץ כפי שהוא.",
    ffmpegPreferenceNote: "המרה מקומית משאירה את האודיו אצלך ומקטינה את זמן ההעלאה.",
    ffmpegSupportWarning: "הדפדפן שלך לא תומך ב-FFmpeg בדפדפן ולכן נעבד את הקובץ בשרת.",
    ffmpegNotSupported: "העיבוד המקומי אינו נתמך במכשיר זה. משתמשים בשרת.",
    ffmpegLocalProcessing: "מכין את הקובץ מקומית...",
    ffmpegLocalProgress: "ממיר מקומית... {progress}%",
    ffmpegLocalComplete: "ההמרה המקומית הושלמה",
    ffmpegLocalFailed: "ההמרה המקומית נכשלה",
    ffmpegRecoveredServer: "ממשיך בהעלאה לשרת במקום.",
    ffmpegCancelled: "ההמרה המקומית בוטלה",
  ...
  const yi = {
    ...
    ffmpegSettingsHeader: "לאָקאַלע באַהאַנדלונג",
    ffmpegAutoLabel: "אָטאָמאַטיש",
    ffmpegAutoHelp: "קלויבט אויטאָמאַטיש צי צו קאָנווערטירן אינעם בלעטערער לויט די רעסורסן פֿון אַפּאַראַט.",
    ffmpegLocalOnly: "קאָנווערטיר אינעם בלעטערער",
    ffmpegLocalOnlyHelp: "מאַכט Opus איידער מען שיקט כדי צו שנעלערן און מינימיזירן דאַטן.",
    ffmpegServerOnly: "קאָנווערטיר אויפן סערווער",
    ffmpegServerOnlyHelp: "שיקט גלייך צום סערווער אָן לאָקאַלע קאָנווערסיע.",
    ffmpegPreferenceNote: "לאָקאַלע קאָנווערסיע בלײַבט אויף דיין קאָמפּיוטער און דאַרף ווייניקער דאַטן.",
    ffmpegSupportWarning: "דער בלעטערער שטיצט נישט FFmpeg לאַקאַל, דעריבער וועלן מיר נוצן דעם סערווער.",
    ffmpegNotSupported: "לאָקאַלע באַהאַנדלונג ווערט נישט געשטיצט. מיר ניצן דעם סערווער.",
    ffmpegLocalProcessing: "פֿאַראַרבעט די טעקע לאָקאַל...",
    ffmpegLocalProgress: "קאָנווערטירט לאָקאַל... {progress}%",
    ffmpegLocalComplete: "לאָקאַלע קאָנווערסיע פאַרענדיקט",
    ffmpegLocalFailed: "לאָקאַלע קאָנווערסיע דורכגעפֿאַלן",
    ffmpegRecoveredServer: "שיקט די טעקע צום סערווער אַנשטאָט.",
    ffmpegCancelled: "לאָקאַלע קאָנווערסיע אָפּגעשטעלט",
  ...
  const en = {
    ...
    ffmpegSettingsHeader: "Browser processing",
    ffmpegAutoLabel: "Automatic",
    ffmpegAutoHelp: "Let us decide when to convert locally based on your device.",
    ffmpegLocalOnly: "Convert in browser",
    ffmpegLocalOnlyHelp: "Transcode to Opus before upload to cut wait time and data size.",
    ffmpegServerOnly: "Convert on server",
    ffmpegServerOnlyHelp: "Skip local conversion and send the original file.",
    ffmpegPreferenceNote: "Local conversion keeps audio on your device and reduces upload size.",
    ffmpegSupportWarning: "Your browser does not support in-browser FFmpeg, so we'll use the server.",
    ffmpegNotSupported: "Local processing is not supported on this device. Using the server.",
    ffmpegLocalProcessing: "Preparing the file locally...",
    ffmpegLocalProgress: "Converting locally... {progress}%",
    ffmpegLocalComplete: "Local conversion complete",
    ffmpegLocalFailed: "Local conversion failed",
    ffmpegRecoveredServer: "Continuing upload via server instead.",
    ffmpegCancelled: "Local conversion canceled",
