(function () {
  const he = {
    ...
    balanceLabel: "יתרה",
    driveStorageLabel: "אחסון Google Drive",
    driveStorageUsageLabel: "{used} מתוך {total}",
    driveStorageUsageNoLimit: "{used} פנויים",
    driveStorageFreeLabel: "{free} פנוי",
    driveStorageFreeOfTotal: "{free} פנויים מתוך {total}",
    driveStorageFetchError: "לא ניתן לוודא את מקום האחסון ב-Google Drive כרגע. נסו שוב בעוד רגע.",
    driveStorageFetchErrorShort: "נתוני אחסון אינם זמינים",
    driveStorageGuardband: "נראה שכמעט ואין מקום פנוי ב-Google Drive. נא להשאיר לפחות {guardband} פנויים לפני ההעלאה.",
    driveStorageInsufficientAudio: "אין מספיק מקום ב-Google Drive כדי לשמור את קובץ האודיו הזה (נדרשים {required}, פנויים {available} לאחר מרווח הבטיחות של {guardband}).",
    loading: "טוען...",
  ...
  const yi = {
    ...
    driveStorageLabel: "Google Drive אָרײַננוצונג",
    driveStorageUsageLabel: "{used} פֿון {total}",
    driveStorageUsageNoLimit: "{used} פֿרײַ",
    driveStorageFreeLabel: "{free} פֿרײַ",
    driveStorageFreeOfTotal: "{free} פֿרײַ פֿון {total}",
    driveStorageFetchError: "מ׳קען איצט נישט באַשטעטיקן Google Drive פּלאַץ. פּרוּווט ווידער שפּעטער.",
    driveStorageFetchErrorShort: "סטאָרידזש־דאַטן ניט־בנימצא",
    driveStorageGuardband: "עס בלײַבט כּמעט קיין פּלאַץ אויף Google Drive. לאָזט לפּחות {guardband} פֿרײַ איידער איר לאָדט אַרויף.",
    driveStorageInsufficientAudio: "עס איז נישט גענוג Google Drive פּלאַץ צו אויפֿהיטן דעם אַודיאָ ({required} דאַרף מען, נאָך דער {guardband} ריזערוו בלײַבט בלויז {available}).",
    loading: "לאָדט...",
  ...
  const en = {
    ...
    driveStorageLabel: "Google Drive storage",
    driveStorageUsageLabel: "{used} of {total}",
    driveStorageUsageNoLimit: "{used} available",
    driveStorageFreeLabel: "{free} free",
    driveStorageFreeOfTotal: "{free} free of {total}",
    driveStorageFetchError: "Couldn't verify your Google Drive space right now. Please try again shortly.",
    driveStorageFetchErrorShort: "Storage info unavailable",
    driveStorageGuardband: "You're almost out of Google Drive space. Please keep at least {guardband} free before uploading.",
    driveStorageInsufficientAudio: "Not enough Google Drive space to save this audio ({required} needed, only {available} left after the {guardband} safety margin).",
    loading: "Loading...",
