(function () {
  const he = {
    ...
    queueBusyTitle: "התור מלא כרגע",
    queueBusyMessage: "התור מלא כרגע. תוכל לנסות להעלות שוב מיד, או לבחור שהקובץ יועלה אוטומטית לתמלול כשיתפנה מקום בתור (עד 48 שעות). הקובץ שלך נשמר זמנית עד שתבחר.",
    queueBusyRetryBtn: "נסה שוב עכשיו",
    queueBusyDeferBtn: "סיים אוטומטית",
    deferralQueued: "הקובץ שלך יתומלל אוטומטית כשיתפנה מקום בתור. תוכל לעקוב אחרי הסטטוס ב\"הקבצים שלי\".",
    errorDeferralFailed: "לא ניתן היה לתזמן את הקובץ לתמלול אוטומטי. אנא נסה שוב.",
    errorDeferralExpired: "הזמן להעברת הקובץ לתמלול אוטומטי פג. אנא העלה את הקובץ מחדש.",
    errorDeferralAlreadyPending: "כבר יש לך קובץ הממתין לתמלול אוטומטי. אנא המתן לסיומו לפני שתבחר שוב באפשרות זו.",
    errorDeferralNotAvailable: "האפשרות לתמלול אוטומטי מאוחר יותר אינה זמינה במצב זה.",
    statusDeferred: "ממתין לפינוי מקום בתור",
  ...
  const yi = {
    ...
    queueBusyTitle: "די ריי איז איצט פֿול",
    queueBusyMessage: "די ריי איז איצט פֿול. איר קענט פּרוּווט ווידער באַלד, אָדער אויסקלײַבן אַז די טעקע זאָל אַרויפֿגעלאָדן ווערן אויטאָמאַטיש ווען עס וועט זײַן אָרט אין דער ריי (ביז 48 שעה). אײַער טעקע ווערט צײַטווײַליק אויפֿגעהיטן ביז איר קלײַבט אויס.",
    queueBusyRetryBtn: "פּרוּווט ווידער איצט",
    queueBusyDeferBtn: "פֿאַרענדיקט אויטאָמאַטיש",
    deferralQueued: "אײַער טעקע וועט ווערן טראַנסקריבירט אויטאָמאַטיש ווען עס וועט זײַן אָרט אין דער ריי. איר קענט נאָכפֿאָלגן דעם סטאַטוס אין \"מײַנע טעקעס\".",
    errorDeferralFailed: "מיר האָבן נישט געקענט צײַטווײַליק אָפּשטעלן די טעקע פֿאַר אויטאָמאַטישע טראַנסקריפּציע. ביטע פּרוּווט ווידער.",
    errorDeferralExpired: "די צײַט צו איבערגעבן די טעקע פֿאַר אויטאָמאַטישע טראַנסקריפּציע איז אַוועק. ביטע לאָדט אַרויף די טעקע פֿון דאָס נײַ.",
    errorDeferralAlreadyPending: "איר האָט שוין אַ טעקע וואָס וואַרט אויף אויטאָמאַטישער טראַנסקריפּציע. ביטע וואַרט ביז זי ענדיקט זיך איידער איר קלײַבט אויס דאָס נאָך אַ מאָל.",
    errorDeferralNotAvailable: "די אויטאָמאַטישע שפּעטערדיקע טראַנסקריפּציע איז נישט צוגענגלעך אין דעם מאָדוס.",
    statusDeferred: "וואַרט אויף אָרט אין דער ריי",
  ...
  const en = {
    ...
    queueBusyTitle: "Queue is currently full",
    queueBusyMessage: "The queue is currently full. You can try uploading again right away, or choose to have this file transcribed automatically once there's room in the queue (up to 48 hours). Your file is held temporarily until you choose.",
    queueBusyRetryBtn: "Retry now",
    queueBusyDeferBtn: "Finish automatically",
    deferralQueued: "Your file will be transcribed automatically when there's room in the queue. You can check its status in My Files.",
    errorDeferralFailed: "We couldn't schedule your file for automatic transcription. Please try again.",
    errorDeferralExpired: "The time to schedule this file for automatic transcription has expired. Please upload the file again.",
    errorDeferralAlreadyPending: "You already have a file waiting for automatic transcription. Please wait for it to finish before choosing this option again.",
    errorDeferralNotAvailable: "Automatic later transcription isn't available in this mode.",
    statusDeferred: "Waiting for queue space",
