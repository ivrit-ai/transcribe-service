(function () {
  ...
  const yi = {
    ...
    errorServerBusy: "דער פּראָיעקט רוט אויף נדבֿות און דער פֿרײַער סערווער איז איצט פֿאַרנומען. איר קענט פּרוּוון ווידער שפּעטער (בעדיפות בנאַכט־שעהען), אָדער טראַנסקריבירן פֿאַר קאָסטן־פּרײַז לויט די אינסטרוקציעס אין ווידעא: https://youtu.be/xr8RQRFERLs.",
  ...
  const en = {
    ...
    errorServerBusy: "This project runs on donations and the free server is currently busy. You can try again later (preferably during nighttime hours), or transcribe at cost following the instructions in this video: https://youtu.be/xr8RQRFERLs.",
